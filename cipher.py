...
#Возвращает данные из файла salt.salt
def load_salt():
    return open("salt.salt", "rb").read()

#Генерация salt и пароли
...
def generate_key(password, salt_size=16, load_existing_salt=False, save_salt=True):
    ...
    # Добавляем генерацию ключа,salt и пароли
    derived_key = derive_key(salt, password)
    return base64.urlsafe_b64encode(derived_key)

#Производим шифрование данных
def encrypt(filename, key):
    ...
    # Перезаписываем исходный файл на зашифрованные данные
    with open(filename, "wb") as file:
        file.write(encrypted_data)

# Производим дешифровку файлов
def decrypt(filename, key):
    ...
    try:
        ...
        return
    #Обновляем данные зашифрованного файла на расшифрованные
    with open(filename, "wb") as file:
...
if __name__ == "__main__":
    ...
    if encrypt_ and decrypt_:
        raise TypeError("Укажите, хотите ли вы зашифровать файл или расшифровать его.")
    elif encrypt_:
        encrypt(file, key)
    elif decrypt_:
        decrypt(file, key)
